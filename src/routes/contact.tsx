  ...
  return (
    <div style={{ backgroundColor: '#F8C21B', minHeight: '100vh' }}>
      ...
      <main className="mx-auto max-w-4xl p-6">
        <h1 className="text-2xl font-bold">{staticT('Contact')}</h1>
        <div className="mt-6 space-y-6 rounded-lg border border-[#6f450e] bg-[#fff8dc] p-6 text-[#6f450e]">
          <section>
            <h2 className="font-semibold">{staticT('Join Community')}</h2>
            <p className="mt-2 text-sm">
              {staticT('A dynamic platform for dialogue and collaboration')}
            </p>
            <div className="mt-3">
              <a
                href="/join-us"
              ...
              >
                {staticT('Start Conversation')}
              </a>
            </div>
          </section>

          <section>
            <h2 className="font-semibold">{staticT('Email us')}</h2>
            <p className="mt-2 text-sm">info@pashusevakvaani.com</p>
            <p className="mt-1 font-mono text-sm tracking-wider">91+ 8059512356</p>
          </section>

          <section>
            <h2 className="font-semibold">{staticT('Reach out to us')}</h2>
            <p className="mt-2 text-sm">
              Herdsman Development Private Limited <br></br>3rd Floor Innov8 Orchid Center, Golf
              Course Road Sector-53, Gurgaon-122002{' '}
            </p>
            <p className="mt-2 text-sm">
              <a
                ...
                className="inline-flex items-center gap-2 text-green-600 no-underline hover:underline"
              >
